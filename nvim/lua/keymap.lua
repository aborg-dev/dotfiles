...
wk.register({h = {name = "+help", s = {":luafile %<CR> | :PackerSync<CR>", "sync plugins"}, r = {":luafile %<CR>", "reload config"}}}, {prefix = "<leader>"})
return wk.register({b = {name = "+buffers", d = {":bd<CR>", "delete"}, n = {":bn<CR>", "next"}, p = {":bp<CR>", "previous"}}}, {prefix = "<leader>"})
